...
import { draw, RectOp, clamp, ZERO_RECT, type Rect, type Vec2 } from "../draw"
import { createEventStream, pointerDragSession } from "../event_stream"
import { createMachine, type Machine } from "../fsm"
